...
class NGLMolecule(NGLWidgets):
    def __init__(self, trajectory) -> None:
        ...
        self.folder = os.path.join(self.tmp_dir,"vibrations")
        # Molecules
        ...
        self.simple_molecules=["O\u2082", "N\u2082", "OH", "H\u2082O", "CO\u2082", "CH\u2084", "NH\u2083","C\u2086H\u2086"]
        self.advanced_molecules=['CH\u2083CHO', 'H\u2082COH', 'OCHCHO', 'C\u2083H\u2089C', 'CH\u2083CH\u2082OCH\u2083', 'HCOOH', 'H\u2082', 'C\u2082H\u2082', 'C\u2084H\u2084NH', 'CH\u2083CO', 'CO', 'C\u2082H\u2086CHOH', 'CH\u2082NHCH\u2082', 'HCO', 'C\u2082H\u2086', 'CN', 'H\u2083CNH\u2082', 'CH\u2083CH\u2082OH', 'C\u2082H\u2083', 'CH\u2083CN', 'CH\u2083ONO', 'CO\u2082', 'NO', 'NH\u2082', 'CH', 'CH\u2082OCH\u2082', 'C\u2086H\u2086', 'CH\u2083CONH\u2082', 'H\u2082CCHCN', 'H\u2082CO', 'CH\u2083COOH', 'N\u2082H\u2084', 'OH', 'CH\u2083OCH\u2083', 'C\u2085H\u2085N', 'H\u2082O', 'CH\u2083NO\u2082', 'C\u2084H\u2084O', 'CH\u2083O', 'CH\u2083OH', 'CH\u2083CH\u2082O', 'C\u2083H\u2087', 'CH\u2083', 'O\u2083', 'C\u2082H\u2084', 'NCCN', 'C\u2082H\u2085', 'N\u2082O', 'HCN', 'C\u2082H\u2086NH', 'C\u2083H\u2088', 'O\u2082', 'NH', 'NH\u2083', 'C\u2083H\u2089N', 'HCOOCH\u2083', 'CCH', 'C\u2085H\u2088', 'CH\u2083COCH\u2083', 'CH\u2084', 'H\u2082CCO', 'CH\u2083CH\u2082NH\u2082', 'N\u2082', 'H\u2082O\u2082', 'NO\u2082','C\u2087NH\u2085','bicyclobutane','methylenecyclopropane','cyclobutene','trans-butane','cyclobutane','butadiene','isobutane', 'BDA', 'biphenyl']
        self.button_advanced_molecule=widgets.RadioButtons()
        self.button_advanced_molecule=widgets.Checkbox(value=False,layout=Layout(width='110px'),description=' ')
        self.button_advanced_molecule_description=widgets.HTMLMath(r"Extended list",layout=Layout(width='100px'))
        self.button_advanced_molecule.observe(self.on_molecule_list_change,"value")
        self.dropdown_molecule_advanced_description=widgets.HTMLMath(r"Molecule",layout=self.layout_description)
    ...
    def print_summary(self, *args):
        ...
        with self.output_summary:
            ...
            values=HBox([
            HTMLMath(value=1*' ',layout=Layout(width="100px")), #Spacer
            HTMLMath(value=f"{self.energies[mode-1]:>12.3f}",layout=self.layout_description),  
            HTMLMath(value=f"{self.frequencies[mode-1]:>12.0f}",layout=self.layout_description),
            ])
            nota_bene=HBox([
            HTMLMath(value=1*' ',layout=Layout(width="100px")), #Spacer
            HTMLMath(value=f"N.B.: Energy and frequency values are indicative and do not represent actual values",layout=Layout(width="260px"))  
            ])
